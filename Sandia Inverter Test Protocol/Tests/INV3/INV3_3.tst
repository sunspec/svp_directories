<scriptConfig name="INV3_3" script="INV3">
  <params>
    <param name="inv3.power_factor" type="float">-0.85</param>
    <param name="inv3.ramp_time" type="int">0</param>
    <param name="invt.posttest_delay" type="int">0</param>
    <param name="inv3.timeout_period" type="int">0</param>
    ...
    <param name="invt.pretest_delay" type="int">35</param>
    <param name="invt.setpoint_failure_count" type="int">65</param>
    <param name="inv3.time_window" type="int">90</param>
    <param name="profile.irr_start" type="float">200.0</param>
    <param name="invt.setpoint_period" type="int">360</param>
