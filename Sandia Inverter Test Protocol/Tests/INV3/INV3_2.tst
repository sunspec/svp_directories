<scriptConfig name="INV3_2" script="INV3">
  <params>
    ...
    <param name="inv3.time_window" type="int">60</param>
    <param name="invt.setpoint_failure_count" type="int">120</param>
    <param name="profile.irr_start" type="float">200.0</param>
    <param name="inv3.timeout_period" type="int">420</param>
    <param name="invt.setpoint_period" type="int">480</param>
