<scriptConfig name="FW21_6" script="FW">
  <params>
    <param name="invt.posttest_delay" type="int">0</param>
    <param name="fw.settings.HzStop" type="float">0.66</param>
    <param name="fw.settings.HzStr" type="float">1.0</param>
