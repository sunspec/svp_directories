<scriptConfig name="FW21_2" script="FW">
  <params>
    <param name="invt.posttest_delay" type="int">0</param>
    <param name="fw.settings.HzStr" type="float">0.66</param>
