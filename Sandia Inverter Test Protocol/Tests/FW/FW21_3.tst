<scriptConfig name="FW21_3" script="FW">
  <params>
    ...
    <param name="fw.settings.HzStop" type="float">0.33</param>
    ...
    <param name="fw.settings.WGra" type="float">50.0</param>
    <param name="invt.setpoint_failure_count" type="int">60</param>
    ...
    <param name="pvsim_profile.irr_start" type="float">500.0</param>
    ...
    <param name="fw.settings.HysEna" type="string">Yes</param>
  </params>
</scriptConfig>
