<scriptConfig name="FW21_1" script="FW">
  <params>
    ...
    <param name="fw.settings.WGra" type="float">10.0</param>
    ...
    <param name="invt.setpoint_failure_count" type="int">300</param>
    ...
    <param name="datatrig.node" type="string">3</param>
