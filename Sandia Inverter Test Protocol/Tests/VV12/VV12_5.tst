<scriptConfig name="VV12_5" script="VV">
  <params>
    ...
    <param name="invt.verification_delay" type="int">120</param>
    <param name="gridsim.ametek.v_nom" type="float">277.2</param>
    <param name="vv.settings.timeout_period" type="int">300</param>
    ...
    <param name="gridsim.ametek.comm" type="string">Serial</param>
