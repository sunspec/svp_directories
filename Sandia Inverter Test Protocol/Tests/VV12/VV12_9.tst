<scriptConfig name="VV12_9" script="VV">
  <params>
    ...
    <param index_count="4" index_start="1" name="vv.curve.volt" type="float">80.0 95.0 105.0 120.0 </param>
    <param index_count="4" index_start="1" name="vv.curve.var" type="float">100.0 0.0 0.0 -100.0 </param>
