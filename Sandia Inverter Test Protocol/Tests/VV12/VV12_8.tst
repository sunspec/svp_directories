<scriptConfig name="VV12_8" script="VV">
  <params>
    ...
    <param name="vv.settings.time_window" type="int">60</param>
    ...
    <param index_count="4" index_start="1" name="vv.curve.volt" type="float">95.0 98.0 102.0 105.0 </param>
