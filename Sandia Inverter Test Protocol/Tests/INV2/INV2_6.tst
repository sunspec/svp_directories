<scriptConfig name="INV2_6" script="INV2">
  <params>
    ...
    <param name="inv2.ramp_time" type="int">45</param>
    <param name="inv2.time_window" type="int">90</param>
    <param name="inv2.power_limit_pct" type="int">100</param>
    <param name="invt.screening_period" type="int">140</param>
