<scriptConfig name="PF_mid_cap" script="SA12_power_factor">
  <params>
    ...
    <param name="gridsim.mode" type="string">Grid Simulator Simulation</param>
    <param name="der.mode" type="string">Manual</param>
    <param name="profile.profile_name" type="string">None</param>
    <param name="ratings.pf_target" type="string">PF_mid_cap</param>
    <param name="pvsim.mode" type="string">PV Simulator Simulation</param>
